	...
	*/
	...
	function renderDoctor(doctor){
		...
		temp += '<p>'+doctor['hostpital']+' '+doctor['department']+'</p></div><a href="#" class="btn btn-primary col-md-2 offset-md-2 appoint-button" id='+doctor['id']+'>Appoint</a></div></div></div></div>'
	}
